...
const SwaggerVisualizer = (function (_React$Component) {
    _inherits(SwaggerVisualizer, _React$Component);

    function SwaggerVisualizer(props) {
        _classCallCheck(this, SwaggerVisualizer);

        return _possibleConstructorReturn(this, (SwaggerVisualizer.__proto__ || Object.getPrototypeOf(SwaggerVisualizer)).call(this, props));
    }
